<?php
// [TIMESTAMP: 2026-03-27] - GAC Tri-Variable Chat Engine FIXED
session_start();
    ...
    <div class="w-full max-w-md bg-slate-900 rounded-2xl shadow-2xl border border-slate-800 overflow-hidden">
        <div class="bg-slate-800 p-4 border-b border-slate-700 flex justify-between items-center">
            <div class="flex items-center space-x-3">
                <div class="w-8 h-8 rounded-lg bg-[#30C89F] flex items-center justify-center font-bold text-slate-900">G</div>
                <h2 class="text-white font-bold text-sm">GAC Campus Help</h2>
            </div>
        ...
        <div id="chatLog" class="chat-box p-4 overflow-y-auto space-y-4">
            <div class="gac-msg p-3 text-xs leading-relaxed">
                Welcome, Scholar. Ask me about any campus building (e.g., "Where is the <strong>Bursar</strong>?" or "I need the <strong>JS Lab</strong>").
            </div>
        </div>
