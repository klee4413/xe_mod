    ...
    <header class="bg-[#000080] border-b-2 border-[#ec4899] py-4 px-8 flex justify-between items-center shadow-2xl">
        <div class="flex items-center gap-4">
            <h1 class="text-2xl font-black italic uppercase tracking-tighter text-white">
                AIGC <span class="text-pink-400">Language to App Programming Code Generation</span> Lab
            </h1>
            <!--p class="text-[10px] uppercase tracking-widest text-blue-300">xxx</p-->
        </div>
    ...
    <main class="flex-grow flex flex-col p-6 gap-6 overflow-hidden">
        ...
        <section class="h-1/3 flex flex-col gap-2">
            <div class="flex justify-between items-center px-2">
                <span class="text-[10px] font-black uppercase text-slate-500 tracking-widest">Natural Language Instruction</span>
                <span class="text-[10px] text-pink-400 font-bold uppercase italic">Input Target logic below</span>
            </div>
            <textarea id="instruction-input" 
                class="w-full flex-grow glass-panel rounded-2xl p-6 outline-none text-blue-300 focus:border-pink-500/50 transition-all text-lg" 
        ...
        <!--section class="flex-grow flex flex-col gap-2">
            <div class="flex justify-between items-center px-2">
                <span class="text-[10px] font-black uppercase text-slate-500 tracking-widest">Generated Foundry Snippet</span>
